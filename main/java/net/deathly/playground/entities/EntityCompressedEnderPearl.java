package net.deathly.playground.entities;
 ...
 */
public class EntityCompressedEnderPearl extends EntityThrowable {
    private EntityLivingBase thrower;

    public EntityCompressedEnderPearl(World worldIn)
    {
        super(worldIn);
    }

    public EntityCompressedEnderPearl(World worldIn, EntityLivingBase throwerIn)
    {
    ...
    public EntityCompressedEnderPearl(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
